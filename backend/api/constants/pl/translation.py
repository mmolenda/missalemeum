...
TITLES = {
    ...
    constants.TEMPORA_ADV3_1_2: 'Poniedziałek po 3 Niedzieli Adwentu',
    constants.TEMPORA_ADV3_1: 'Poniedziałek po 3 Niedzieli Adwentu',
    constants.TEMPORA_ADV3_2_2: 'Wtorek po 3 Niedzieli Adwentu',
    ...
    constants.TEMPORA_ADV3_4_2: 'Czwartek po 3 Niedzieli Adwentu',
    ...
    constants.TEMPORA_ADV4_1_2: 'Poniedziałek po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_2: 'Wtorek po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_2_2: 'Wtorek po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_3: 'Środa po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_3_2: 'Środa po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_4: 'Czwartek po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_4_2: 'Czwartek po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_5: 'Piątek po 4 Niedzieli Adwentu',
    constants.TEMPORA_ADV4_5_2: 'Piątek po 4 Niedzieli Adwentu',
    ...
    constants.SANCTI_01_11: 'Św. Hygina, Papieża i Męczennika',
    ...
    constants.SANCTI_01_14C: 'Św. Feliksa, Kapłana i Męczennika',
    constants.SANCTI_01_15: 'Św. Pawła, Pierwszego Pustelnika, Wyznawcy',
    constants.SANCTI_01_15C: 'Św. Maura, Opata',
    ...
    constants.SANCTI_01_19C: 'św. Kanuta, Króla i Męczennika',
    ...
    constants.SANCTI_01_28C: 'Św. Agnieszki',
    ...
    constants.SANCTI_03_04C: 'Św. Lucjusza I, Papieża i Męczennika',
    ...
    constants.SANCTI_04_29: 'Św. Piotra z Werony, Męczenika',
    ...
    constants.SANCTI_05_19C: 'Św. Pudencjany, Dziewicy',
    ...
    constants.SANCTI_06_12C: 'Śś. Bazylidesa, Cyryna, Nabora i Nazariusza, Męczenników',
    ...
    constants.SANCTI_06_15PL: 'Bł. Jolanty, Wdowy',
    ...
    constants.SANCTI_06_18C: 'Śś. Marka i Marcelina, Męczenników',
    constants.SANCTI_06_19: 'Św. Juliany Falconieri, Dziewicy',
    constants.SANCTI_06_19C: 'Śś. Gerwazego i Protazego, Męczenników',
    ...
    constants.SANCTI_07_02C: 'Śś. Procesa i Martyniana, Męczenników',
    ...
    constants.SANCTI_07_12C: 'Śś. Nabora i Feliksa, Męczenników',
    constants.SANCTI_07_13PL: 'Śś. Andrzeja Świerada i Benedykta, Wyznawców',
    ...
    constants.SANCTI_07_15PL: 'Św. Brunona Bonifacego z Kwerfurtu, Biskupa i Męczennika',
    ...
    constants.SANCTI_07_25C: 'Św. Krzysztofa, Męczennika',
    ...
    constants.SANCTI_07_29C: 'Śś. Feliksa, Symplicjusza, Faustyna i Beatryczy, Męczenników',
    ...
    constants.SANCTI_08_02C: 'Św. Stefana I, Papieża i Męczennika',
    ...
    constants.SANCTI_08_08C: 'Śś. Cyriaka, Larga i Szmaragda, Męczenników',
    constants.SANCTI_08_09: 'Wigilia św. Wawrzyńca, Męczennika',
    constants.SANCTI_08_09C: 'Św. Romana, Męczennika',
    ...
    constants.SANCTI_08_14C: 'Św. Euzebiusza, Wyznawcy',
    ...
    constants.SANCTI_08_22C: 'Śś. Tymoteusza, Hipolita i Symforiana, Męczenników',
    ...
    constants.SANCTI_08_28C: 'Św. Hermesa, Męczennika',
    constants.SANCTI_08_29: 'Ścięcie Św. Jana Chrzciciela',
    constants.SANCTI_08_29C: 'Św. Sabiny, Męczennicy',
    ...
    constants.SANCTI_09_08C: 'Św. Hadriana, Męczennika',
    ...
    constants.SANCTI_09_15C: 'Św. Nikomedesa, Męczennika',
    constants.SANCTI_09_16: 'Św. Korneliusza, Papieża i Cypriana, Męczenników',
    constants.SANCTI_09_16C: 'Śś. Eufemii, Łucji i Geminiana, Męczenników',
    ...
    constants.SANCTI_09_22C: 'Śś. Maurycego i Towarzyszy, Męczenników',
    constants.SANCTI_09_23: 'Św. Linusa, Papieża i Męczennika',
    constants.SANCTI_09_23C: 'Św. Tekli, Dziewicy i Męczennicy',
    ...
    constants.SANCTI_11_10C: 'Śś. Tryfona, Respicjusza i Nimfy, Męczenników',
    ...
    constants.SANCTI_11_24C: 'Św. Chryzogona, Męczennika',
    ...
    constants.VOTIVE_PRO_UNITATE_ECCLESIAE: 'Msza o Jedność Kościoła',
...
VOTIVE_MASSES = [
    ...
    {'ref': 'pro-unitate-ecclesiae', 'id': constants.VOTIVE_PRO_UNITATE_ECCLESIAE,
     'title': TITLES[constants.VOTIVE_PRO_UNITATE_ECCLESIAE], 'tags': ['Wotywna', 'W różnych potrzebach']},
...
TRANSFORMATIONS = TRANSFORMATIONS_COMMON + [
    (lambda x: 'Gloria' in x, re.compile(r'^[&$]Gloria\.*'), 'Chwała Ojcu…'),
    (lambda x: 'Oremus' in x, re.compile(r'^\$Oremus\.*'), 'Módlmy się.'),
    (lambda x: 'Per' in x and 'eiusdem' in x, re.compile(r'^\$Per D[oó]minum eiusdem\.*'), 'Przez Pana…'),
    (lambda x: 'Per' in x and 'minum' in x, re.compile(r'^\$Per D[oó]minum\.*'), 'Przez Pana…'),
    (lambda x: 'Per' in x and 'dem' in x, re.compile(r'^\$Per eu[mn]dem\.*'), 'Przez tegoż Pana…'),
    (lambda x: 'Qui tecum' in x, re.compile(r'^\$Qui tecum eiusdem\.*'), 'Który z Tobą…'),
    (lambda x: 'Qui tecum' in x, re.compile(r'^\$Qui tecum\.*'), 'Który z Tobą…'),
    (lambda x: 'Qui vivis' in x, re.compile(r'^\$Qui vivis\.*'), 'Który żyjesz…'),
    (lambda x: 'Deo' in x and 'ratias' in x, re.compile(r'^\$Deo [Gg]ratias\.*'), 'Bogu dzięki.'),
    (lambda x: 'Dominus' in x and 'obiscum' in x, re.compile(r'^[&$]Dominus *[Vv]obiscum\.*'), '℣. Pan z wami.    \n\r℟. I z duchem twoim.'),
