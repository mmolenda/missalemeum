...
def get_pages(pallotinum: Optional[int] = None) -> List[str]:
    if pallotinum is None:
        return []
    return [
...
PAGES = {
    ...
    constants.SANCTI_01_05: get_pages(740),  # 'Św. Telesfora, Papieża i Męczennika',
    constants.SANCTI_01_06: get_pages(107),  # 'Objawienie Pańskie',
    constants.SANCTI_01_11: get_pages(740),  # 'Św. Hygina, Papieża i Męczennika',
    ...
    constants.SANCTI_01_14C: get_pages(741),  # 'Św. Feliksa, Kapłana i Męczennika',
    constants.SANCTI_01_15: get_pages(741),  # 'Św. Pawła, Pierwszego Pustelnika, Wyznawcy',
    constants.SANCTI_01_15C: get_pages(744),  # 'Św. Maura, Opata',
    ...
    constants.SANCTI_01_19C: get_pages(746),  # 'św. Kanuta, Króla i Męczennika',
    ...
    constants.SANCTI_01_23C: get_pages(755),  # 'Św. Emercjanny, Dziewicy i Męczennicy',
    ...
    constants.SANCTI_01_25C: get_pages(),  # 'Św. Piotra, Apostoła',
    ...
    constants.SANCTI_01_28C: get_pages(762),  # 'Św. Agnieszki',
    ...
    constants.SANCTI_02_06C: get_pages(783),  # 'Św. Doroty, Dziewicy i Męczennicy',
    ...
    constants.SANCTI_02_09C: get_pages(785),  # 'Św. Apolonii, Dziewicy i Męczennicy',
    ...
    constants.SANCTI_02_22C: get_pages(),  # 'Św. Pawła',
    ...
    constants.SANCTI_03_04C: get_pages(804),  # 'Św. Lucjusza I, Papieża i Męczennika',
    ...
    constants.SANCTI_03_08PL: get_pages(808),  # 'Bł. Wincentego Kadłubka',
    ...
    constants.SANCTI_03_17PL: get_pages(814),  # 'Św. Jana Sarkandra, Męczennika',
    ...
    constants.SANCTI_04_14T: get_pages(845),  # 'Śś. Tyburcjusza, Waleriana i Maksyma, Męczenników',
    ...
    constants.SANCTI_04_25C: get_pages(851),  # 'Litania Większa',
    ...
    constants.SANCTI_05_03: get_pages(871),  # 'Śś. Aleksandra, Ewencjusza i Teodula, Męczenników',
    ...
    constants.SANCTI_05_10C: get_pages(878),  # 'Śś. Gordiana i Epimacha, Męczenników',
    ...
    constants.SANCTI_05_19C: get_pages(893),  # 'Św. Pudencjany, Dziewicy',
    ...
    constants.SANCTI_05_25C: get_pages(898),  # 'Św. Urbana I, Papieża i Męczennika',
    constants.SANCTI_05_26: get_pages(898),  # 'Św. Filipa Nereusza, Wyznawcy',
    constants.SANCTI_05_26C: get_pages(900),  # 'Św. Eleuteriusza, Papieża i Męczennika',
    constants.SANCTI_05_27: get_pages(900),  # 'Św. Bedy Czcigodnego, Wyznawcy i Doktora Kościoła',
    constants.SANCTI_05_27C: get_pages(901),  # 'św. Jana I, Papieża i Męczennika',
    ...
    constants.SANCTI_05_31C: get_pages(906),  # 'Św. Petroneli, Dziewicy',
    constants.SANCTI_06_01: get_pages(908),  # 'Św. Anieli Merici, Dziewicy',
    constants.SANCTI_06_01PL: get_pages(906),  # 'Bł. Jakuba Strzemię, Biskupa i Wyznawcy',
    ...
    constants.SANCTI_06_12C: get_pages(925),  # 'Śś. Bazylidesa, Cyryna, Nabora i Nazariusza, Męczenników',
    ...
    constants.SANCTI_06_18C: get_pages(934),  # 'Śś. Marka i Marcelina, Męczenników',
    constants.SANCTI_06_19: get_pages(936),  # 'Św. Juliany Falconieri, Dziewicy',
    constants.SANCTI_06_19C: get_pages(937),  # 'Śś. Gerwazego i Protazego, Męczenników',
    ...
    constants.SANCTI_07_02C: get_pages(969),  # 'Śś. Procesa i Martyniana, Męczenników',
    ...
    constants.SANCTI_07_12C: get_pages(981),  # 'Śś. Nabora i Feliksa, Męczenników',
    constants.SANCTI_07_13PL: get_pages(),  # 'Śś. Andrzeja Świerada i Benedykta, Wyznawców',
    ...
    constants.SANCTI_07_15PL: get_pages(),  # 'Św. Brunona Bonifacego z Kwerfurtu, Biskupa i Męczennika',
    ...
    constants.SANCTI_07_18C: get_pages(989),  # 'Śś. Symforozy i Siedmiu Jej Synów',
    ...
    constants.SANCTI_07_20C: get_pages(994),  # 'Św. Małgorzaty, Dziewicy i Męczennicy',
    ...
    constants.SANCTI_07_21C: get_pages(995),  # 'Św. Praksedy, Dziewicy',
    ...
    constants.SANCTI_07_23C: get_pages(1004),  # 'Św. Liboriusza, Biskupa i Wyznawcy',
    ...
    constants.SANCTI_07_25C: get_pages(1008),  # 'Św. Krzysztofa, Męczennika',
    ...
    constants.SANCTI_07_29C: get_pages(1012),  # 'Śś. Feliksa, Symplicjusza, Faustyna i Beatryczy, Męczenników',
    ...
    constants.SANCTI_08_02C: get_pages(1022),  # 'Św. Stefana I, Papieża i Męczennika',
    ...
    constants.SANCTI_08_06C: get_pages(1028),  # 'Śś. Sykstusa II, Papieża, Felicysyma i Agapita, Męczenników',
    constants.SANCTI_08_07: get_pages(1028),  # 'Św. Kajetana, Wyznawcy',
    constants.SANCTI_08_07C: get_pages(1029),  # 'Św. Donata, Biskupa i Męczennika',
    constants.SANCTI_08_08: get_pages(1032),  # 'Św. Jana Marii Vianney, Wyznawcy',
    constants.SANCTI_08_08C: get_pages(1032),  # 'Śś. Cyriaka, Larga i Szmaragda, Męczenników',
    constants.SANCTI_08_09: get_pages(1034),  # 'Wigilia św. Wawrzyńca, Męczennika',
    constants.SANCTI_08_09C: get_pages(1036),  # 'Św. Romana, Męczennika',
    ...
    constants.SANCTI_08_14C: get_pages(1043),  # 'Św. Euzebiusza, Wyznawcy',
    ...
    constants.SANCTI_08_22C: get_pages(1059),  # 'Śś. Tymoteusza, Hipolita i Symforiana, Męczenników',
    ...
    constants.SANCTI_08_26: get_pages(),  # 'Św. Zefiryna, Papieża i Męczennika',
    ...
    constants.SANCTI_08_28C: get_pages(1072),  # 'Św. Hermesa, Męczennika',
    constants.SANCTI_08_29: get_pages(1073),  # 'Ścięcie Św. Jana Chrzciciela',
    constants.SANCTI_08_29C: get_pages(1075),  # 'Św. Sabiny, Męczennicy',
    constants.SANCTI_08_30: get_pages(1076),  # 'Św. Róży z Limy, Dziewicy',
    constants.SANCTI_08_30C: get_pages(1077),  # 'Śś. Feliksa i Adaukta, Męczenników',
    ...
    constants.SANCTI_09_01C: get_pages(1080),  # 'Śś. Dwunastu Braci, Męczenników',
    ...
    constants.SANCTI_09_08C: get_pages(1089),  # 'Św. Hadriana, Męczennika',
    ...
    constants.SANCTI_09_15C: get_pages(1100),  # 'Św. Nikomedesa, Męczennika',
    constants.SANCTI_09_16: get_pages(1101),  # 'Św. Korneliusza, Papieża i Cypriana, Męczenników',
    constants.SANCTI_09_16C: get_pages(1101),  # 'Śś. Eufemii, Łucji i Geminiana, Męczenników',
    ...
    constants.SANCTI_09_22C: get_pages(1108),  # 'Śś. Maurycego i Towarzyszy, Męczenników',
    constants.SANCTI_09_23: get_pages(1110),  # 'Św. Linusa, Papieża i Męczennika',
    constants.SANCTI_09_23C: get_pages(1100),  # 'Św. Tekli, Dziewicy i Męczennicy',
    ...
    constants.SANCTI_10_07C: get_pages(1133),  # 'Św. Marka I, Papieża i Wyznawcy',
    constants.SANCTI_10_08: get_pages(1133),  # 'Św. Brygidy, Wdowy',
    constants.SANCTI_10_08C: get_pages(1134),  # 'Śś. Sergiusza, Bachusa, Marcelego i Apulejusza',
    constants.SANCTI_10_09: get_pages(1135),  # 'Św. Jana Leonardi, Wyznawcy',
    constants.SANCTI_10_09C: get_pages(1137),  # 'Śś. Dionizego, Rustyka i Eleuteriusza',
    constants.SANCTI_10_10: get_pages(1142),  # 'Św. Franciszka Borgiasza, Wyznawcy',
    constants.SANCTI_10_10PL: get_pages(1140),  # 'Dziękczynienie za zwycięstwo chocimskie z roku 1621',
    ...
    constants.SANCTI_10_21C: get_pages(1157),  # 'Śś. Urszuli i Towarzyszek, Dziewic i Męczennic',
    ...
    constants.SANCTI_10_26: get_pages(1163),  # 'Św. Ewarysta, Papieża i Męczennika',
    ...
    constants.SANCTI_11_04C: get_pages(1179),  # 'Śś. Witalisa i Agrykoli, Męczenników',
    ...
    constants.SANCTI_11_09C: get_pages(1183),  # 'Św. Teodora, Męczennika',
    constants.SANCTI_11_10: get_pages(1184),  # 'Św. Andrzeja z Avellino, Wyznawcy',
    constants.SANCTI_11_10C: get_pages(1185),  # 'Śś. Tryfona, Respicjusza i Nimfy, Męczenników',
    constants.SANCTI_11_11: get_pages(1186),  # 'Św. Marcina, Biskupa i Wyznawcy',
    constants.SANCTI_11_11C: get_pages(1188),  # 'Św. Mennasa, Męczennika',
    ...
    constants.SANCTI_11_19C: get_pages(1201),  # 'Św. Poncjana, Papieża i Męczennika',
    ...
    constants.SANCTI_11_23C: get_pages(1205),  # 'Św. Felicyty, Męczennicy',
    constants.SANCTI_11_24: get_pages(1206),  # 'Św. Jana od Krzyża, Wyznawcy i Doktora Kościoła',
    constants.SANCTI_11_24C: get_pages(1206),  # 'Św. Chryzogona, Męczennika',
    ...
    constants.SANCTI_11_26C: get_pages(1209),  # 'Św. Piotra z Aleksandrii, Biskupa i Męczennika',
    ...
    constants.SANCTI_12_26C: get_pages(),  # 'Oktawa Bożego Narodzenia',
    constants.SANCTI_12_27: get_pages(92),  # 'Św. Jana, Apostoła i Ewangelisty',
    constants.SANCTI_12_27C: get_pages(),  # 'Oktawa Bożego Narodzenia',
    constants.SANCTI_12_28: get_pages(94),  # 'Świętych Młodzianków',
    constants.SANCTI_12_28C: get_pages(),  # 'Oktawa Bożego Narodzenia',
