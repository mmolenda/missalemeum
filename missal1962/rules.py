...
rules = (
    ...
    (lambda day, lit_days_ids: SANCTI_01_13_1 in lit_days_ids and TEMPORA_EPI1_0 in lit_days_ids,
     (TEMPORA_EPI1_0,)),
    (lambda day, lit_days_ids: set(FEASTS_OF_JESUS_CLASS_1_AND_2).intersection(set(lit_days_ids)) and any([patterns['tempora-sunday-class-2'].match(i) for i in lit_days_ids]),
