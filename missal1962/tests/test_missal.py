...
class TestMissal(unittest.TestCase):
    ...
    def test_tempora(self):
        ...
        for year, dates in sorted(expected.items()):
            ...
            self.assertEqual(self._to_date_obj(dates[6]), missal.get_day_by_id(TEMPORA_ADV1_0)[0])
            ...
            self.assertEqual(self._to_date_obj(dates[9]), missal.get_day_by_id(NAT2_0)[0])
            self.assertEqual(self._to_date_obj(dates[10]), missal.get_day_by_id(SANCTI_10_DUr)[0])
    ...
    def test_semi_sancti_days_all_souls(self):
        missal = MissalFactory.create(2008)
        self.assertEqual(date(2008, 11, 3), missal.get_day_by_id(SANCTI_11_02_1)[0])
        missal = MissalFactory.create(2014)
        self.assertEqual(date(2014, 11, 3), missal.get_day_by_id(SANCTI_11_02_1)[0])
        missal = MissalFactory.create(2015)
        self.assertEqual(date(2015, 11, 2), missal.get_day_by_id(SANCTI_11_02_1)[0])
        missal = MissalFactory.create(2063)
        self.assertEqual(date(2063, 11, 2), missal.get_day_by_id(SANCTI_11_02_1)[0])

    def test_semi_sancti_days_feb_24_related(self):
        missal = MissalFactory.create(2012)
        self.assertEqual(date(2012, 2, 25), missal.get_day_by_id(SANCTI_02_24_1)[0])
        self.assertEqual(date(2012, 2, 28), missal.get_day_by_id(SANCTI_02_27_1)[0])
        missal = MissalFactory.create(2016)
        self.assertEqual(date(2016, 2, 25), missal.get_day_by_id(SANCTI_02_24_1)[0])
        self.assertEqual(date(2016, 2, 28), missal.get_day_by_id(SANCTI_02_27_1)[0])
        missal = MissalFactory.create(2017)
        self.assertEqual(date(2017, 2, 24), missal.get_day_by_id(SANCTI_02_24_1)[0])
        self.assertEqual(date(2017, 2, 27), missal.get_day_by_id(SANCTI_02_27_1)[0])
        missal = MissalFactory.create(2018)
        self.assertEqual(date(2018, 2, 24), missal.get_day_by_id(SANCTI_02_24_1)[0])
    ...
    def test_concurrency_1_2_class_feast_of_the_Lord_occurring_on_sunday_2_class(self):
        self.assertEqual([SANCTI_01_06_1],
    ...
    def test_liturgical_day_model_tempora_rank_advent(self):
        # 2002
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_1, date(2002, 12, 16)).rank, 3)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_2, date(2002, 12, 17)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_3, date(2002, 12, 18)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_4, date(2002, 12, 19)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_5, date(2002, 12, 20)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_6, date(2002, 12, 21)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV4_0, date(2002, 12, 22)).rank, 1)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV4_1, date(2002, 12, 23)).rank, 2)
        # 2015
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_2, date(2015, 12, 15)).rank, 3)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_3, date(2015, 12, 16)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_4, date(2015, 12, 17)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_5, date(2015, 12, 18)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV3_6, date(2015, 12, 19)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV4_0, date(2015, 12, 20)).rank, 1)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV4_1, date(2015, 12, 21)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV4_2, date(2015, 12, 22)).rank, 2)
        self.assertEqual(LiturgicalDay(TEMPORA_ADV4_3, date(2015, 12, 23)).rank, 2)
