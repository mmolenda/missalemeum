...
SUNDAY = 6
LANGUAGE_LATIN = 'la'
LANGUAGE_VERNACULAR = 'pt'
DIVOFF_LANG_MAP = {'la': 'Latin', 'pl': 'Polski', 'en': 'English', 'pt': 'Portugues'}
...
PATTERN_TEMPORA_CLASS_4 = re.compile(r'^tempora:.*:4$')
...
PATTERN_SANCTI_CLASS_4 = re.compile(r'^sancti:.*:4$')
